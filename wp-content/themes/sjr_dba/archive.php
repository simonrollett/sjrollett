...
<div class="page-main col-12 float-anchor sjr-archive">
        ...
        ?>
            ...
            <div class="media col-12" id="post-<?php the_ID(); ?>">
                ...
                <div class="pad-EW media-excerpt-wrapper col-9 col-10-d">
                    <h3 class="media-heading"><a href="<?php the_permalink() ?>" rel="bookmark"><?php echo $string; ?>...</a></h3>
    ...
    <div class="col-12 col-3-t secondary">
        ...
        <div class="col-12 panel-latest">
            <div class="widget-wrapper" id="<?php echo $GLOBALS['cart_anchor_id'];?>">
                <?php
