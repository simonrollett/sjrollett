...
?>
    ...
    <section class="body col-12 content-type-<?php echo get_post_type( $post ); ?>" id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/ImageGallery">
        ...
        if ( $query->have_posts() ) {
            ...
            while ( $query->have_posts() ) {
                $query->the_post();
                //$preview_img_url = wp_get_attachment_image_src(get_post_thumbnail_id($projects[0]->ID), array(400, 400), false, '');
